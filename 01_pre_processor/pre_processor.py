...
def geom_create():
    """Creates the geometry of the wing based on the wing paramters set

    Wing parameter abbreviations are:
    r - root, t - tip, b - span, le - leading edge, te - trailing edge, 
    S - planform area, AR - aspect ratio 
    """
    r_chord = 1
    taper_ratio = 1
